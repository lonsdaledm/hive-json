...
public class TestJsonSchemaFinder {
    ...
    public void testLists() throws Exception {
        ...
        list.add(new LazilyParsedNumber("50000"));
        assertEquals("list<int>", JsonSchemaFinder.pickType(list).toString());
        list = new JsonArray();
        list.add(new LazilyParsedNumber("127"));
        list.add(new LazilyParsedNumber("50000"));
        list.add(new LazilyParsedNumber("50000000000"));
        list.add(new LazilyParsedNumber("-100"));
    ...
    public void testNumericMerges() throws Exception {
        ...
        assertEquals("uniontype<double,string>", JsonSchemaFinder.mergeType(
                new NumericType(HiveType.Kind.DECIMAL, 20, 10),
                new StringType(HiveType.Kind.STRING)
        ).toString());
    ...
    public void testUnionMerges() throws Exception {
        assertEquals("uniontype<double,boolean,string>", JsonSchemaFinder.mergeType(
                new UnionType()
